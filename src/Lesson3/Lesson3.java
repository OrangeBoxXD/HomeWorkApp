...
public class Lesson3 {
    public static void main(String[] args) {
        ...
        int whichTask = taskNumber.nextInt();
        switch(whichTask) {
            ...
            case 2:
                System.out.println(Arrays.toString(HundredLenghtArray()));
                break;
            ...
            System.out.println(Arrays.toString(MoveHowMuch(-10, ILikeToMoveItMoveIt(HundredLenghtArray()))));
            break;
        }
    }
    ...
    static void DoubleIfLess5() {
        ...
        System.out.println("Enter lenght of new array:");
        Scanner stringLenght = new Scanner(System.in);
        Random arrayRandom = new Random();
    ...
    static String[] MakeAnArray() {
        System.out.println("Enter len and initialValue separated by space");
